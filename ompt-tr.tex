...
typedef struct {
Ê Ê void *variable_addr;
Ê Ê Êsize_tÊlen;
Ê Ê Êompt_dependence_type_tÊ type;
} ompt_task_dependence_t

typedef enum ompt_target_map_flag_e {
  ompt_target_map_flag_sync = 1,
  ompt_target_map_flag_to = 2
...
{\color{red} TODO: add target records, as they are allowed on a target device}
...
typedef struct ompt_record_s {
  ...
  ompt_task_id_t target_task_id    /* link back to its associated target task */
  union
  {
