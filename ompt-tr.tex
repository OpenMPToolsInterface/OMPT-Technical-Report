...
\item \verb|omp_state_wait_target_map| 
...
the value \verb|omp_state_first| should be supplied for \verb|current_state| in the call to \verb|ompt_enumerate_state| that begins the enumeration.
...
\begin{quote}
\begin{verbatim}
omp_state_t state = omp_state_first;
...
%\verb|ompt_record_correlation| if the purpose of the record is to associate the identier for a device activity with a host target task id, 
...
typedef enum omp_state_e {
  /* work states (0..15) */
  omp_state_work_serial            = 0x00, /* working outside parallel   */
  omp_state_work_parallel          = 0x01, /* working within parallel    */
  omp_state_work_reduction         = 0x02, /* performing a reduction     */

  /* idle (16..31) */
  omp_state_idle                   = 0x10, /* waiting for work           */
 ...
 /* task wait states (80..95) */
  ...
  omp_state_first                  = 0x81, /* initial enumeration state  */
} omp_state_t;
\end{verbatim}
\clearpage
...
typedef enum  ompt_task_type_e {
  ...
  ompt_task_target     = 4,
  ompt_task_target_enter_data    = 5,
  ompt_task_target_exit_data = 6,
  ompt_task_target_update = 7,
  ompt_task_degenerate = 8
} ompt_task_type_t;
...
typedef void (*ompt_task_create_callback_t) ( /* for new tasks       */
  ompt_task_id_t parent_task_id,    /* ID of parent task            */
...
typedef void (*ompt_task_schedule_callback_t) (
  ompt_task_id_t prior_task_id,
  _Bool prior_completed,
  ompt_task_id_t next_task_id
);
...
OMPT_API omp_state_t ompt_get_state( /* get the state for a thread                      */
