...
\begin{quote}
\begin{verbatim}
OMPT_API void ompt_record_native_set(
  int device_id,                     /* target device id                */
  ompt_bool enable,                  /* enable or disable               */
...
To inspect a native trace record for a device, a tool invokes the following function to obtain a pointer to a trace record in the native format for the device associated with the buffer:
\begin{quote}
\begin{verbatim}
...
typedef void (*ompt_target_callback_t) ( /* target* region end events */
  ompt_task_id_t target_task_id     /* ID of task                   */
);
...
typedef void (*ompt_data_map_callback_t) (
  ompt_task_id_t task_id            /* ID of task performing map    */
);
