...
The OpenMP runtime issues this callback for dependences between a producer (\verb|first_task_id|) 
...
Note that this callback may not report information regarding completed dependences of already finished tasks.
This callback has type signature \verb|ompt_task_dependence_pair_callback_t|. 
\end{description}
...
typedef void (*ompt_new_workshare_callback_t) ( /* for workshares   */			   
  ompt_parallel_id_t parallel_id,   /* ID of parallel region        */
  ompt_task_id_t  task_id,          /* ID of task                   */
  void *codeptr                             /* return address for workshare call */
);								    
