...
\begin{comment}
Function \verb|ompt_target_get_id| returns the ID of the current target region:
\begin{quote}
\begin{verbatim}
OMPT_API ompt_target_id_t ompt_target_get_id(void);
\end{verbatim}
\end{quote}
...
typedef void (*ompt_target_data_map_begin_callback_t) (
  ompt_task_id_t task_id,           /* ID of encountering task      */
  int device_id,                    /* ID of the device             */
  ompt_target_map_entry_t *items, /* the items to be mapped */
...
typedef void (*ompt_target_buffer_complete_callback_t) (
  ompt_target_buffer_t *buffer,   /* pointer to buffer with target event records */
