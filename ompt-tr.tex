...
\descheader{Target Task Completion}

\begin{description}

\item \verb|ompt_event_target_task_end_async|   
 
\sloppy
The OpenMP runtime invokes this callback after a target task completes on a device.
The callback may execute in an arbitrary context on an arbitrary thread that may be of type \verb|ompt_thread_other|.
This callback has type signature \verb|ompt_target_task_end_callback_t|.
