...
This callback has type signature \verb|ompt_end_parallel_callback_t|. 
...
\begin{quote}
\begin{verbatim}
OMPT_API ompt_record_correlation_t *ompt_trace_get_correlation(
  ompt_buffer_t *buffer, 
  ompt_trace_cursor_t current
);
\end{verbatim}
...
OMPT_API ompt_record_t *ompt_trace_get_ompt(
  ompt_buffer_t *buffer,
  ompt_trace_cursor_t current
);

OMPT_API void *ompt_trace_get_correlation(
  ompt_buffer_t *buffer,
  ompt_trace_cursor_t current
);
